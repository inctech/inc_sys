...
public class AliyunSms {
    ...
    public SendSmsResponse sendSms(Map<String, String> paramMap) throws com.aliyuncs.exceptions.ClientException {
    ...
    final String accessKeyId = "LTAIfQKrOnwybAES";
    final String accessKeySecret = "F8ZymFgQiZDOQNEYw6jq3sE48tlO52";
}